...
/**
 * 类TransDirCancelTest.java的实现描述：撤销
 * @author tulu 2016年4月27日 下午3:16:12
 */
public class TransDirCancelTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        nvps.add(new BasicNameValuePair("origOrderNo", new SimpleDateFormat("yyyyMMddHHmmss").format(new Date())));
