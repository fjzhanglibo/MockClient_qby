...
/**
 * 类TransDirConsumeTest.java的实现描述：消费
 * @author tulu 2016年4月27日 下午3:15:55
 */
public class TransDirConsumeTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        nvps.add(new BasicNameValuePair("productId", "0103"));
        ...
        nvps.add(new BasicNameValuePair("acctNo", "4270202235500123"));
        nvps.add(new BasicNameValuePair("cvn2", "123"));
