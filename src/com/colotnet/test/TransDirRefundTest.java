...
/**
 * 类TransDirRefundTest.java的实现描述：退货
 * @author tulu 2016年4月27日 下午3:16:49
 */
public class TransDirRefundTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        nvps.add(new BasicNameValuePair("origOrderDate", "2015123"));
        nvps.add(new BasicNameValuePair("origOrderNo", "201512311234"));
        ...
        nvps.add(new BasicNameValuePair("refundReson", ""));
