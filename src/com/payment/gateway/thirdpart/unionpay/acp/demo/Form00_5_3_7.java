 ...
 * Function: 5.3.7　Preauthorization Completion Cancellation<br>
...
public class Form00_5_3_7 extends DemoBase {
	...
	public static Map<String, String> setFormDate() {
		...
		// Order No. of preauthorization completion cancellation, generated by merchant
		contentData.put("orderId", getOrderId());// M
		// Original transaction serial No.. The queryId of the original preauthorization or preauthorization completion should be entered.
		contentData.put("origQryId", "");// M
		// Date and time when order is sent　
		contentData.put("txnTime", getCurrentTime());// M
		// Transaction amount, which should be consistent with that of original preauthorized transaction
