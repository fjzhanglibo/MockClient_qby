...
import com.payment.gateway.util.XMLUtil;
/**
 * 后台应答类<br/>
 *
 */
public class ResponseHelper {
	...
	*/
	...
	public boolean verifySign() {
		...
		//算出摘要
		String sign = SHA256Util.SHA256Encode(sb.toString(), "UTF-8").toLowerCase();
		System.out.println("string:"+sb);
		System.out.println("sign:"+sign);
		
		String epaylinksSign = this.getParameter("sign").toLowerCase();
		System.out.println("epaylinksSign:"+epaylinksSign);
		//调试信息
