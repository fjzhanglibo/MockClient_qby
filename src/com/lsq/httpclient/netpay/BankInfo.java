...
//	PrivateKey hzfPriKey = TestUtil.getPrivateKey();
	...
	while (i<1) {
		...
		try {
			...
			sBuilder.append("<merchantId>199100000051</merchantId>");
//			sBuilder.append("<mobileNo>19910000029</mobileNo>");  //持卡人手机号，如果是实体商户,则该参数必传
			sBuilder.append("<handleType>0</handleType>");  //0：新增 1：删除。默认为“0：新增”
			sBuilder.append("<bankCode>308</bankCode>");
			sBuilder.append("<bankaccProp>0</bankaccProp>"); //0-对私，1-对公
			sBuilder.append("<name>方五一</name>");   //
			sBuilder.append("<bankaccountNo>690755030832564</bankaccountNo>");//4367420060540647482  ，6222800105016832046
			sBuilder.append("<bankaccountType>1</bankaccountType>");  //1-借记卡;2-贷记卡;3-存折
			sBuilder.append("<certCode>1</certCode>");
			sBuilder.append("<certNo>210304198503040045</certNo>");
